...
describe('accessibility of the form', () => {
  ...
  context('Field: Name', () => {
    ...
    it('should accept valid input', () => {
      ...
      cy.get('#signupName').closest('.form-group').find('.invalid-feedback').should('not.exist');
    });
  });
  ...
  context('Field: Email', () => {
    ...
    it('should accept valid input', () => {
      ...
      cy.get('#signupEmail').closest('.form-group').find('.invalid-feedback').should('not.exist');
    });
  });
